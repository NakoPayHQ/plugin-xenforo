...
namespace NakoPay\BtcPay\Pub\Controller;
...
class Payment extends AbstractController
{
    public function actionIndex(ParameterBag $params)
    {
        ...
        $client   = new \NakoPay\BtcPay\ApiClient();
        $db       = \XF::db();
        ...
        return $this->view('NakoPay\BtcPay:Payment\Checkout', 'nakopay_checkout', $viewParams);
    }
    ...
    public function actionPoll(ParameterBag $params)
    {
        ...
        return $this->view('NakoPay\BtcPay:Payment\Poll', '', [
            'status'        => $order['status'],
